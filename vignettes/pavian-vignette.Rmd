...
![Pavian interface with the example data loaded. You can change the name of the sample set, or individual samples. Click 'Save table' after any change. Click 'Browse' to upload custom .report files. ](load-data-set.png)
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.7\textwidth]{comp-heatmap1.png}
\caption{In the heatmap view, the data can be visualized in this intuitive way, clustering samples and taxa by abundances.}
\end{figure}
